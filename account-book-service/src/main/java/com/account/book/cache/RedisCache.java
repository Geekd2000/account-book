package com.account.book.cache;
...
public class RedisCache implements ICache {
    ...
    @Override
    public Long zDel(String key, String value) {
        return redisTemplate.opsForZSet().remove(key, value);
    }

    @Override
    public Set<ZSetOperations.TypedTuple<String>> zRangeScore(String key, long min, double max) {
