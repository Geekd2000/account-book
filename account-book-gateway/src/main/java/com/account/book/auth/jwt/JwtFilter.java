...
//            return executeLogin(request, response); todo jwt filter
    ...
    protected boolean executeLogin(ServletRequest request, ServletResponse response) {
        ...
        String token = httpServletRequest.getHeader(AuthConstant.ACCESS_TOKEN);
    ...
    protected boolean preHandle(ServletRequest request, ServletResponse response) throws Exception {
        ...
        httpServletResponse.setHeader("Access-Control-Allow-Headers", httpServletRequest.getHeader("x-requested-with,content-type"));
